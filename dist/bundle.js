...
var dataBase = void 0;
var visitsConnection = __webpack_require__(4);
var templatesConnection = __webpack_require__(3);
var reportsConnection = __webpack_require__(2);
var siteConnection = __webpack_require__(28);
                        ...
                        valueSubPanel.elements.forEach(function (valueSubPanelEle, indexSubPanelEle) {
                            ...
                            switch (valueSubPanelEle.type) {
                                ...
                                case "image2Labels":
                                    ...
                                    $("#" + valueSubPanel.id + "> .panel-body").append("<div id='" + valueSubPanelEle.idDiv + "' class='" + valueSubPanelEle.divClass + "'>" + "<div id='" + valueSubPanelEle.idDiv + "'class='thumbnail' align='center'>" + "<h3>" + valueSubPanelEle.labels.firstLabel + "<a class='anchorjs-link' href='#thumbnail-label'><span class='anchorjs-icon'></span></a></h3>" + "<img width='450' height='600' style='width: 450px;height: 600px' src='" + defaultImg + "' class='" + valueSubPanelEle.class + "' id='" + valueSubPanelEle.id + "'>" + "<div class='caption'> <h3>" + valueSubPanelEle.labels.secondLabel + "<a class='anchorjs-link' href='#thumbnail-label'><span class='anchorjs-icon'></span></a></h3> " + " <p><input type='file' id='" + valueSubPanelEle.id + "Event' accept='image/*' capture='camera'></p></div> </div>" + "</div>");
                                ...
                                case "image1Label":
                                    ...
                                    $("#" + valueSubPanel.id + "> .panel-body").append("<div id='" + valueSubPanelEle.idDiv + "' class='" + valueSubPanelEle.divClass + "'>" + "<div id='" + valueSubPanelEle.idDiv + "' class='thumbnail' align='center'>" + "<img width='450' height='600' style='width: 450px;height: 600px' src='" + defaultImg + "' class='" + valueSubPanelEle.class + "' id='" + valueSubPanelEle.id + "'>" + "<div class='caption'> <h3>" + valueSubPanelEle.labels.firstLabel + "<a class='anchorjs-link' href='#thumbnail-label'><span class='anchorjs-icon'></span></a></h3> " + " <p><input type='file' id='" + valueSubPanelEle.id + "Event' accept='image/*'     capture='camera'></p></div> </div>" + "</div>");
...
var visits = __webpack_require__(4);
var smartEngine = __webpack_require__(10);
var templates = __webpack_require__(3);
var reports = __webpack_require__(2);
var indexDb = __webpack_require__(8);
var message = __webpack_require__(1);
    ...
    var smartDocsOffline = {
        ...
        loadEventNewVisit: function loadEventNewVisit() {
            ...
            $("#new_VisitBtn").click(function () {
                ...
                $("#site_name_register").on("input", function () {
                    var site = $("#site_name_register").val();
        ...
        getAllTemplates: function getAllTemplates() {
            ...
            if (navigator.onLine) {
                $.get("https://smart-docs.herokuapp.com/templates/", function (templatesResponse) {
                    ...
                    try {
                        for (var _iterator4 = templates.templates[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        ...
        fillVisitsPage: function fillVisitsPage() {
            ...
            try {
                ...
                for (var _iterator5 = visitsResponse[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                    _loop2();
                }
            } catch (err) {
        ...
        fillBoxesReportsRelated: function fillBoxesReportsRelated(reportsFiltered) {
            ...
            try {
                ...
                for (var _iterator6 = reportsFiltered[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                    _loop3();
                }
            } catch (err) {
        ...
        fillTemplatesPage: function fillTemplatesPage() {
            ...
            try {
                ...
                for (var _iterator7 = templatesResponse[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                    _loop4();
                }
            } catch (err) {
        ...
        fillReportsPage: function fillReportsPage() {
            ...
            try {
                for (var _iterator8 = reportsResponse[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                    var _report = _step8.value;
        ...
        fillReportsLogPage: function fillReportsLogPage() {
            ...
            try {
                for (var _iterator9 = reportsLogResponse[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
                    var reportLog = _step9.value;
