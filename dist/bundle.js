...
module.exports = {
    ...
    "startIndexedDB": function startIndexedDB() {
        ...
        return new Promise(function (resolve, reject) {
            ...
            reference.dataBase.onupgradeneeded = function (e) {
                ...
                var visits = active.createObjectStore("visits", { keyPath: 'visitId' });
    ...
    "addVisit": function addVisit(visitId, siteId, name, author, cloud) {
        var creationDate = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : "" + new Date();
...
var uidGenerator = __webpack_require__(12);
