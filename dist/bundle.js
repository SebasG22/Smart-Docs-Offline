...
module.exports = {
    addMessageLoder: function addMessageLoder(selector, location) {
    ...
    changeMessageLoader: function changeMessageLoader(selector, msg) {
        console.log("Selector: " + selector);
        console.log("Message: " + msg);
        $("#" + selector).text(msg);
    },
    removeMessageLoader: function removeMessageLoader(location) {
        $("#loader").remove();
        $(location).removeClass("loader");
    },
    launchProcessImageModal: function launchProcessImageModal() {
        $("#process_image_modal").remove();
        $("body").append("<div class='fade modal modal-warning'aria-hidden=true aria-labelledby=myModalLabel1 id=process_image_modal role=dialog style=display:block tabindex=-1><div class=modal-dialog><div class=modal-content><div class=modal-header><h4 class=modal-title id=myModalLabel13>La imagen esta siendo procesada </h4></div><div class=modal-body> <img src='/mapIcon.svg' style='margin-left:auto;margin-right:auto;display:block' width='150px'><h4 style='text-align:center'> Espera un momento, este proceso puede tomar algunos segundos dependiendo de tu conexion</h4></div></div></div></div>");
        $("#process_image_modal").modal({ backdrop: 'static', keyboard: false });
    },
    removeProcessImageModal: function removeProcessImageModal() {
...
module.exports = {
    "sendNotification": function sendNotification(title, body) {
...
module.exports = {
    ...
    "showTable": function showTable(tableId) {
        var reference = this;
        var tableValues = JSON.parse($("#" + tableId + "Value").val());
            ...
            tableVal.forEach(function (val, index) {
                ...
                if (index == tableVal.length - 1) {
                    ...
                    $("#" + tableVal[0] + "Del").click(function () {
                        var id = this.id;
                        var dataSearch = id.replace("Del", "");
                        var tableData = JSON.parse($("#" + tableId + "Value").val());
    ...
    "addToTable": function addToTable(tableId, values, indix) {
        var reference = this;
        //console.log("Add to table in action" + values);
        var tableValues = $("#" + tableId + "Value").val();
        $("#" + tableId + "> tbody").html("");
        if (tableValues != "") {
    ...
    allInputs: [],
    "executeEngine": function executeEngine(template) {
        var reference = this;
        reference.allInputs = [];
        ...
        template.tabs.forEach(function (valueTab, indexTab) {
            valueTab.navtab.forEach(function (valuenavTab, indexnavTab) {
                //Generating navTabs
                $("#templateNavTabs").append("<li role='" + valueTab.role + "' class='" + valueTab.class + "'>" + "<a href='#" + valuenavTab.location + "' role='" + valuenavTab.role + "' aria-controls='" + valuenavTab.location + "' data-toggle='" + valuenavTab.data_toggle + "' >" + valuenavTab.title + "</a></li>");
                ...
                valueTab.panel.forEach(function (valueTabPanel, indexTabPanel) {
                    ...
                    valueTabPanel.subpanel.forEach(function (valueSubPanel, indexSTabContent) {
                        $("#" + valuenavTab.location).append("<div id='" + valueSubPanel.id + "' class='" + valueSubPanel.class + "'> " + "<div class='panel-heading'><h3 class='panel-title'></h3>" + valueSubPanel.title + "</div>" + "<div class='panel-body'>" + "</div></div>");

                        var typeInside = void 0;
                        ...
                        valueSubPanel.elements.forEach(function (valueSubPanelEle, indexSubPanelEle) {
                            ...
                            switch (valueSubPanelEle.type) {
                                ...
                                case "date":case "datetime":case "time":case "month":case "week":
                                    ...
                                    switch (valueSubPanelEle.type) {
                                        case "date":
                                            typeInside = "date";break;
                                        case "datetime":
                                            typeInside = "datetime-local";break;
                                        case "time":
                                            typeInside = "time";break;
                                        case "week":
                                            typeInside = "week";break;
                                        case "month":
                                            typeInside = "month";break;
                                    }
                                ...
                                case "radio":case "checkbox":
                                    ...
                                    switch (valueSubPanelEle.type) {
                                        ...
                                        case "radio":
                                            typeInside = "radio";break;
                                        case "checkbox":
                                            typeInside = "checkbox";break;
                                    ...
                                    valueSubPanelEle.options.forEach(function (listItem, indexList) {
                                        $("#" + valueSubPanelEle.idDiv).append("<div class='" + valueSubPanelEle.class + "'>" + "<input type='" + typeInside + "' id='id" + id_gen + "' name='" + valueSubPanelEle.name + "'  value='" + listItem.value + "'> <label for='id" + id_gen + "'> " + listItem.label + "</label></div>");
                                ...
                                case "image2Labels":
                                    ...
                                    $("#" + valueSubPanel.id + "> .panel-body").append("<div id='" + valueSubPanelEle.idDiv + "' class='" + valueSubPanelEle.divClass + "'>" + "<div id='" + valueSubPanelEle.idDiv + "'class='thumbnail' align='center'>" + "<h3>" + valueSubPanelEle.labels.firstLabel + "<a class='anchorjs-link' href='#thumbnail-label'><span class='anchorjs-icon'></span></a></h3>" + "<img width='450' height='450' style='width: 450px;height: 450px' src='" + defaultImg + "' class='" + valueSubPanelEle.class + "' id='" + valueSubPanelEle.id + "'>" + "<div class='caption'> <h3>" + valueSubPanelEle.labels.secondLabel + "<a class='anchorjs-link' href='#thumbnail-label'><span class='anchorjs-icon'></span></a></h3> " + " <p><input type='file' id='" + valueSubPanelEle.id + "Event' accept='image/*' capture='camera'></p></div> </div>" + "</div>");
                                ...
                                case "image1Label":
                                    ...
                                    $("#" + valueSubPanel.id + "> .panel-body").append("<div id='" + valueSubPanelEle.idDiv + "' class='" + valueSubPanelEle.divClass + "'>" + "<div id='" + valueSubPanelEle.idDiv + "' class='thumbnail' align='center'>" + "<img width='450' height='450' style='width: 450px;height: 450px' src='" + defaultImg + "' class='" + valueSubPanelEle.class + "' id='" + valueSubPanelEle.id + "'>" + "<div class='caption'> <h3>" + valueSubPanelEle.labels.firstLabel + "<a class='anchorjs-link' href='#thumbnail-label'><span class='anchorjs-icon'></span></a></h3> " + " <p><input type='file' id='" + valueSubPanelEle.id + "Event' accept='image/*'     capture='camera'></p></div> </div>" + "</div>");
    ...
    allInputsFilled: [],
    "validateField": function validateField(name, type, selector) {
        var reference = this;
        var defaultImg = "data:image/png;base64,";
        switch (type) {
    ...
    "saveAnswer": function saveAnswer() {
        ...
        reference.allInputs.forEach(function (value, index) {
    ...
    "matchAnswers": function matchAnswers(allInputsAnswer) {
        var reference = this;
    ...
    "watermark": function watermark(selector) {}
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
(function () {
    var smartDocsOffline = {
        ...
        updateSiteExternal: function updateSiteExternal() {
            return new Promise(function (resolve, reject) {
                $.get("https://smart-docs.herokuapp.com/sites/", function (sitesResponse) {
                    ...
                    try {
                        for (var _iterator2 = sitesResponse[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        changeActiveMenu: function changeActiveMenu(id_page) {
            $(".active").removeClass("active");
            $("#" + id_page).addClass("active");
        },
        changePage: function changePage(page_route) {
            var reference = this;
        ...
        loadResources: function loadResources(page_route) {
            var reference = this;
            switch (page_route) {
                case "allVisits":
                    message.addMessageLoder("loaderMessage", "#mainContent2");
        ...
        "siteOptSelected": "",
        loadEventNewVisit: function loadEventNewVisit() {
            var reference = this;
        ...
        addEventsReportRelated: function addEventsReportRelated() {
            var reference = this;
        ...
        getAllTemplates: function getAllTemplates() {
            ...
            if (navigator.onLine) {
                $.get("https://smart-docs.herokuapp.com/templates/", function (templatesResponse) {
                    ...
                    try {
                        for (var _iterator5 = templates.templates[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
        ...
        fillVisitsPage: function fillVisitsPage() {
            ...
            try {
                ...
                for (var _iterator6 = visitsResponse[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                    _loop2();
                }
            } catch (err) {
        ...
        fillBoxesReportsRelated: function fillBoxesReportsRelated(reportsFiltered) {
            var reference = this;
            ...
            try {
                var _loop3 = function _loop3() {
                    ...
                    var templateFilter = templatesResponse.filter(function (template) {
                ...
                for (var _iterator7 = reportsFiltered[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                    _loop3();
                }
            } catch (err) {
        ...
        fillTemplatesPage: function fillTemplatesPage() {
            ...
            try {
                ...
                for (var _iterator8 = templatesResponse[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                    _loop4();
                }
            } catch (err) {
        ...
        saveAnswerEvent: function saveAnswerEvent() {
            ...
            $("#btnSave").click(function () {
                var answer = smartEngine.saveAnswer();
                ...
                var answerObj = JSON.parse(answer.userAnswer);
        ...
        fillReportsPage: function fillReportsPage() {
            var reference = this;
            ...
            try {
                for (var _iterator9 = reportsResponse[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
        ...
        fillReportsLogPage: function fillReportsLogPage() {
            var reference = this;
            //let templatesResponse = templates.getTemplates();
            ...
            try {
                for (var _iterator10 = reportsLogResponse[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
                    var reportLog = _step10.value;
